...
.cover {text-align:center; border-radius: 50px; background: white; margin: 80px auto; padding: 23px 50px; width: auto; height: auto; }
.survey_title{color:brown;}    
...
<div class ="container">
	<div class="cover">
	<h1 class="survey_title">동 물 &nbsp 병 원</h1><br>
		<img src="/palette/images/songpa.png" style="width:500px; height:400px;">
	</div>
</div>
</div>
